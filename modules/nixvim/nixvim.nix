...
in
{
  imports = [
    ...
    # Add your plugins to ./config/plugins and import them below
    # ./config/plugins/transparent.nix # TODO
    ./config/plugins/toggleterm.nix
    #./config/plugins/project-nvim.nix
    ./config/plugins/alpha.nix
  ...
  */
  ...
  extraPackages = with pkgs; [
    gopls
    delve # go debugger
    imagemagick # for image.nvim sixels
    # neovim-remote # for git/jj commit message editing in toggleterm.nvim
    tree-sitter
  ];
